...
Skill for keeping `.docs/*.md` in sync with the actual GDScript source code in this project.

## When to run

Run this skill automatically at the **start of every session** before answering any questions, and whenever invoked via `/sync-docs`.
